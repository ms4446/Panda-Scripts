...
#####
KEYS_TO_USE = ['id', 'all_artists', 'title', 'medium','dataText',
               'aquisitionYear', 'height', 'width', 'units']
...
SAMPLE_JSON = os.path.join('/Users/amandashay/Documents/corepy','collection-master','artworks',
...
def read_artworks_from_json(keys_to_use):
    ...
    directory.
    """
    JSON_ROOT = os.path.join('/Users/amandashay/Documents/corepy', 'collection-master',
                             'artworks')
    artworks =[]
